...
public class AdminEventDetailedActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_event_detailed);
        Intent intent = getIntent();
        String fetchID =  intent.getStringExtra("eventID");
        progressDialog = new ProgressDialog(AdminEventDetailedActivity.this);
        ...
        updateBtn.setOnClickListener(v -> {
            Intent intent1 = new Intent(AdminEventDetailedActivity.this, UpdateEventActivity.class);
            intent1.putExtra("eventID",fetchID);
            startActivity(intent1);
        });
        deleteBtn.setOnClickListener(v -> {
            Intent intent1 = new Intent(AdminEventDetailedActivity.this, Event_Delete_Request.class);
            intent1.putExtra("eventID",fetchID);
            startActivity(intent1);
        });
            ...
            public boolean onNavigationItemSelected(@NonNull @org.jetbrains.annotations.NotNull MenuItem item) {
                ...
                switch (id){
                    case R.id.nav_event_home:
                        ...
                        Toast.makeText(AdminEventDetailedActivity.this, "Event Home is Clicked", Toast.LENGTH_SHORT).show();
                        startActivity(new Intent(AdminEventDetailedActivity.this, HomeActivity.class));
                        break;
                    case R.id.nav_add_event:
                        drawerLayout.closeDrawer(GravityCompat.START);
                        Toast.makeText(AdminEventDetailedActivity.this, "Add Event is Clicked", Toast.LENGTH_SHORT).show();
                        startActivity(new Intent(AdminEventDetailedActivity.this, CreateEventActivity.class));
                        break;
                    case R.id.nav_items_home:
                        drawerLayout.closeDrawer(GravityCompat.START);
                        Toast.makeText(AdminEventDetailedActivity.this, "Items Home is Clicked", Toast.LENGTH_SHORT).show();
                        startActivity(new Intent(AdminEventDetailedActivity.this, HomeActivity.class));
                        break;
                    ...
                    case R.id.nav_logout:
                        drawerLayout.closeDrawer(GravityCompat.START);
                        Toast.makeText(AdminEventDetailedActivity.this, "Logout is Clicked", Toast.LENGTH_SHORT).show();
                        progressDialog.show();
                    ...
                    case R.id.nav_share:
                        drawerLayout.closeDrawer(GravityCompat.START);
                        Toast.makeText(AdminEventDetailedActivity.this, "Share Link is Clicked", Toast.LENGTH_SHORT).show();break;
                    case R.id.nav_contact:
                        drawerLayout.closeDrawer(GravityCompat.START);
                        Toast.makeText(AdminEventDetailedActivity.this, "Contact us is Clicked", Toast.LENGTH_SHORT).show();break;
                    default:
                        drawerLayout.closeDrawer(GravityCompat.START);
                        break;
                }return true;
    ...
    private void showAlert(String title, String message) {
        AlertDialog.Builder builder = new AlertDialog.Builder(AdminEventDetailedActivity.this)
                .setTitle(title)
                .setMessage(message)
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        Intent intent = new Intent(AdminEventDetailedActivity.this, HomeActivity.class);
