...
public class AdminEventUpdateActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog = new ProgressDialog(AdminEventUpdateActivity.this);
        ...
        cancelBtn.setOnClickListener( v -> {
            Intent intent1 = new Intent(AdminEventUpdateActivity.this, DetailedEventActivity.class);
                ...
                eventObject.saveInBackground(new SaveCallback() {
                    ...
                    public void done(ParseException e) {
                        ...
                        if (e == null) {
                            ...
                            // Error
                            Toast.makeText(AdminEventUpdateActivity.this, e.getMessage(), Toast.LENGTH_LONG).show();
    ...
    private void showAlert(String title, String message) {
        AlertDialog.Builder builder = new AlertDialog.Builder(AdminEventUpdateActivity.this)
                .setTitle(title)
                .setMessage(message)
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        Intent intent = new Intent(AdminEventUpdateActivity.this, DetailedEventActivity.class);
    ...
    private void showDateTimeDialog(EditText date_time_in){
        ...
        DatePickerDialog.OnDateSetListener dateSetListener=new DatePickerDialog.OnDateSetListener() {
            ...
            public void onDateSet(DatePicker datePicker, int year, int month, int dayOfMonth) {
                ...
                new TimePickerDialog(AdminEventUpdateActivity.this,timeSetListener,calendar.get(Calendar.HOUR_OF_DAY),calendar.get(Calendar.MINUTE),false).show();
            }
        };
        new DatePickerDialog(AdminEventUpdateActivity.this,dateSetListener,calendar.get(Calendar.YEAR),calendar.get(Calendar.MONTH),calendar.get(Calendar.DAY_OF_MONTH)).show();
    }
